        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center">
              <img
                src="https://png.pngtree.com/png-vector/20230420/ourmid/pngtree-modern-digital-security-logo-for-tech-business-company-privacy-safe-vector-png-image_51573914.jpg"
